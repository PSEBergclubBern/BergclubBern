...
@section('content')
    <table border="0" cellspacing="0" cellpadding="10">
        ...
        <tr>
            ...
            <td><button id="button-touren" class="button button-primary button-download" data-href="?page={{ $_GET['page'] }}&download=touren.xls&status=any&from=01.01.{{ date('Y') }}&to=31.12.{{ date('Y') }}">Herunterladen</button></td>
        </tr>
        <tr>
