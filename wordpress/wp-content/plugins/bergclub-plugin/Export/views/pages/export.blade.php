...
@section('content')
    <table border="0" cellspacing="0" cellpadding="10">
        ...
        <tr>
            ...
            <td colspan="2"><label><input type="radio" class="download-address" name="download-address" value="addresses"/> Komplett</label>&nbsp;&nbsp;&nbsp;<label><input type="radio" class="download-address" name="download-address" value="shipping" checked/> Programm</label></td>
        ...
        <tr>
            ...
            <td colspan="2"><label><input type="radio" class="touren-data" name="download-touren-status" value="any" checked/> Alle</label>&nbsp;&nbsp;&nbsp;<label><input type="radio" class="touren-data" name="download-touren-status" value="publish"/> Publizierte</label>&nbsp;&nbsp;&nbsp;<label for="download-touren-from">Von:</label> <input type="text" class="datepicker touren-data" id="download-touren-from" value="01.01.{{ date("Y") }}" size="8"/> <label for="download-touren-to">Bis:</label> <input type="text" class="datepicker touren-data" id="download-touren-to" value="31.12.{{ date("Y") }}" size="8"/></td>
        ...
        <tr>
            ...
            <td><button id="button-pfarrblatt" class="button button-primary button-download" data-href="?page={{ $_GET['page'] }}&download=pfarrblatt&from=01.01.{{ date('Y') }}&to=31.12.{{ date('Y') }}">Herunterladen</button></td>
        </tr>
        <tr>
    ...
    <script type="text/javascript">
        ...
        function updatePfarrblattDownload() {
            ...
            var href = '?page={{ $_GET['page'] }}&download=pfarrblatt&from=' + from + '&to=' + to;
        ...
        function updateProgramDownload() {
            ...
            var href = '?page={{ $_GET['page'] }}&download=program&touren-from=' + tourenFrom + '&touren-to=' + tourenTo + '&review-from=' + reviewFrom + '&review-to=' + reviewTo;
